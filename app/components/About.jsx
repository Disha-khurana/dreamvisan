...
function About() {
  return (
    <div className="lg:flex items-center justify-center w-full gap-12 px-5 xl:px-32">
      <div className="lg:w-1/2">
        <h2 className="text-[#f7941d] font-bold text-xl mb-5">
          BASED IN PEMBERTON, BRITISH COLUMBIA
        </h2>
        <p className="text-base text-gray-700 mb-3 leading-relaxed text-justify">
          Founded in 2020, Kentel Construction was established in an effort to
        ...
        <p className="text-base text-gray-700 leading-relaxed text-justify">
          Based in Pemberton, with a reach across the Sea to Sky, we pride
